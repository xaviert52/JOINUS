  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 pt-10 relative z-10">
      ...
      >
        ...
        <h1 className="font-black text-6xl md:text-8xl tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-zinc-200 to-zinc-600 drop-shadow-2xl" style={{ fontWeight: 900 }}>
          THE FINANCIAL <br/>
          <span className="font-black font-mono bg-clip-text bg-gradient-to-r from-red-500 to-red-900 drop-shadow-[0_0_20px_rgba(220,38,38,0.5)]" style={{ fontWeight: 900 }}>REVOLUTION</span>
        </h1>
