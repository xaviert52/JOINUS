  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 pt-10 relative z-10">
      ...
      >
        ...
        <h1 className="text-zinc-400 font-bold text-6xl md:text-8xl tracking-tight leading-none">WE ENCODE <br/> <span className="font-black text-red-600">LONG-TERM</span> THINKING.</h1>
