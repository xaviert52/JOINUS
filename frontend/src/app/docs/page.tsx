      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 mt-10">
          ...
          <div className="bg-[#0a0a0a]/80 border border-zinc-800/80 backdrop-blur-xl rounded-2xl p-6 shadow-2xl sticky top-24 h-fit">
            ...
            <nav className="flex flex-col gap-4">
              <div className="space-y-2">
                ...
                <a href="#asymptotic-economics" className={`block text-xs font-medium transition-colors border-l-2 pl-3 py-1 ${activeSection === 'asymptotic-economics' ? 'text-zinc-300 border-red-500 bg-red-500/5' : 'text-zinc-500 border-transparent hover:border-zinc-700 hover:text-zinc-300'}`}>
              ...
              <div className="space-y-2 pt-4 border-t border-zinc-800/50">
                ...
                <a href="#adr-009" className={`block text-xs font-medium transition-colors border-l-2 pl-3 py-1 ${activeSection === 'adr-009' ? 'text-zinc-300 border-red-500 bg-red-500/5' : 'text-zinc-500 border-transparent hover:border-zinc-700 hover:text-zinc-300'}`}>
        ...
        <main className="lg:w-3/4">
          ...
          <div className="space-y-12">
            ...
            <section id="governance-balance" className="scroll-mt-24 min-h-[60vh] bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              ...
              <div className="prose prose-invert prose-zinc max-w-none">
                ...
                <div id="zk-proofs" className="scroll-mt-32 min-h-[60vh] bg-red-950/10 border-l-4 border-red-600 p-8 rounded-r-2xl relative overflow-hidden mt-6">
            ...
            {/* ASYMPTOTIC ECONOMICS */}
            <section id="asymptotic-economics" className="scroll-mt-32 min-h-[60vh] bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
            ...
            <section id="adr-009" className="scroll-mt-32 min-h-[60vh] bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                <span className="bg-zinc-800 text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-lg border border-zinc-700 w-max">
                  ADR-009
                </span>
            ...
            {/* ADR-016 */}
            <section id="adr-016" className="scroll-mt-32 min-h-[60vh] bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                <span className="bg-zinc-800 text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-lg border border-zinc-700 w-max">
                  ADR-016
                </span>
            ...
            {/* ADR-019 */}
            <section id="adr-019" className="scroll-mt-32 min-h-[60vh] bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                <span className="bg-zinc-800 text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-lg border border-zinc-700 w-max">
                  ADR-019
                </span>
            ...
            {/* ADR-020 */}
            <section id="adr-020" className="scroll-mt-32 min-h-[60vh] bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
                <span className="bg-zinc-800 text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-lg border border-zinc-700 w-max">
                  ADR-020
                </span>
