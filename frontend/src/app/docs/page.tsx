      ...
      <div className="flex flex-col lg:flex-row gap-12 mt-10">
          ...
          <div className="bg-[#0a0a0a]/80 border border-zinc-800/80 backdrop-blur-xl rounded-2xl p-6 shadow-2xl sticky top-28">
            ...
            <nav className="flex flex-col gap-4">
              ...
              <div className="space-y-2 pt-4 border-t border-zinc-800/50">
                ...
                <Link href="/docs/apy" className="block text-xs font-medium text-zinc-400 hover:text-white transition-colors border-l-2 border-transparent hover:border-zinc-700 pl-3 py-1">
                  APY & RewardPool
                </Link>
        ...
        <main className="lg:w-3/4">
          ...
          <div className="space-y-12">
            ...
            <section id="governance-balance" className="bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
            ...
            <section id="apy" className="bg-[#050505] border border-zinc-800/80 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
