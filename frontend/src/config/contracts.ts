...
export const JNS_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_JNS_TOKEN_ADDRESS as `0x${string}`;
export const JNS_STAKING_ADDRESS = process.env.NEXT_PUBLIC_JNS_STAKING_ADDRESS as `0x${string}`;
